...
with(this){return _c('h3',{attrs:{"id":"the-find-command"}},[_v("The find command"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#the-find-command","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("The find command follows the same high-level flow as other commands in the "),_c('strong',[_v("Logic component")]),_v(". To implement the find command, the "),_c('a',{attrs:{"href":"https://docs.oracle.com/javase/8/docs/api/java/util/function/Predicate.html"}},[_v("java.util.function.Predicate")]),_v(" class is extensively used. The internal "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ArgumentMultiMap")]),_v(" class used in the add command parser is also made use of. Parsing is handled by the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FindCommandParser")]),_v(" class, a more lower-level sequence diagram showcasing how the valid input \"n/John\" is parsed is included below.\n"),_c('strong',[_v("NOTE")]),_v(": The sequence diagram omits error checking logic for simplicity.")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("NOTE")]),_v(": As like other sequence diagrams in this guide, the lifeline for "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("a:ArgumentMultiMap")]),_v(" should end at the destroy marker (X) but due to a limitation of PlantUML, the lifeline continues till the end of diagram.\nParsing other valid prefixes (\"t/\", \"r/\" \"p/\") is different to how \"n/\" is parsed in the use of other XYZContainsKeywordsPredicates than NameContainsKeywordsPredicate class ("),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TagsContainsKeywordsPredicate")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("RoleContainsKeywordsPredicate")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PhoneNumberContainsKeywordsPredicate")]),_v(" respectively).")])}
},function anonymous(
) {
...
with(this){return _c('h4',{attrs:{"id":"added-classes"}},[_v("Added classes"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#added-classes","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CsvAddressBookStorage")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VcfAddressBookStorage")]),_v(" — Implementations of AddressBookStorage with methods tailored to the target filetypes")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CsvAdaptedPerson")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VcfAdaptedPerson")]),_v(" — Adapted Person classes with datatypes suitable to be stored in the target filetype")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CsvSerializableAddressBook")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VcfSerializableAddressBook")]),_v(" — Holds Adapted Persons for processing in implementations of AddressBookStorage")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VcfMapper")]),_v(" — Contains static methods to convert "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VcfAdaptedPerson")]),_v("s to vCard objects")])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"sequence-flow-of-export-to-csv-feature"}},[_v("Sequence flow of Export to CSV feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#sequence-flow-of-export-to-csv-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ExportCommand::execute")]),_v(" is invoked, which instantiates a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CsvAddressBookStorage")]),_v(" with the filename")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ExportCommand::execute")]),_v(" invokes the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CsvAddressBookStorage::saveAddressBook")]),_v(" method with the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBook")]),_v(" which saves all contacts in the address book to a file")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CsvAddressBookStorage::saveAddressBook")]),_v(" instantiates a new "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CsvSerializableAddressBook")]),_v(" to format all "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Person")]),_v(" object properties to CSV friendly formats.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CsvAddressBookStorage::saveAddressBook")]),_v(" uses the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("List")]),_v(" of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CsvAdaptedPersons")]),_v(" to create the export file using the Jackson library (ez-vcard library for VCF)")])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"error-handling"}},[_v("Error handling"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#error-handling","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Filename validity")]),_v(" "),_c('li',[_v("File with same name exists in "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("exports/")]),_v(" directory")]),_v(" "),_c('li',[_v("Address book is empty")]),_v(" "),_c('li',[_v("IO errors when creating file")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("How the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("import")]),_v(" command works:")])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("The user enters an import command (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("import addressbook.csv")]),_v(").")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogicManager")]),_v(" passes the command to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v(".")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v(" creates an "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ImportCommandParser")]),_v(" to parse the arguments.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ImportCommandParser")]),_v(" validates the file path and creates an "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ImportCommand")]),_v(".")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogicManager")]),_v(" executes the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ImportCommand")]),_v(" with the current model.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ImportCommand")]),_v(" determines the file type and calls the appropriate parser:\n"),_c('ul',[_c('li',[_v("For CSV files: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CsvParser")]),_v(" reads and parses the CSV file, then "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ImportCommand")]),_v(" processes the raw data and creates "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Person")]),_v(" objects.")]),_v(" "),_c('li',[_v("For VCF files: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VcfParser")]),_v(" reads and parses the VCF file using the ez-vcard library and returns a list of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Person")]),_v(" objects.")])])]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ImportCommand")]),_v(" adds each valid person to the model.")]),_v(" "),_c('li',[_v("Duplicate entries are detected during the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addPerson")]),_v(" operation.")]),_v(" "),_c('li',[_v("A "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CommandResult")]),_v(" is returned with a message indicating success or listing errors.")])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"error-handling-2"}},[_v("Error handling"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#error-handling-2","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("File format errors (invalid headers, malformed data).")]),_v(" "),_c('li',[_v("Validation errors (invalid phone numbers, emails, etc.).")]),_v(" "),_c('li',[_v("Duplicate entries (contacts that already exist in the address book).")]),_v(" "),_c('li',[_v("Duplicate entries within the imported file itself.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("Alternative 1 (current choice):")]),_v(" Use a fixed imports directory.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Simplifies the command syntax and provides a standard location for import files.")]),_v(" "),_c('li',[_v("Con: Less flexible for users.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 2:")]),_v(" Allow arbitrary file paths.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: More flexibility for users.")]),_v(" "),_c('li',[_v("Cons: More complex command syntax and security considerations")])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("has a need to manage a significant number of contacts")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")]),_v(" "),_c('li',[_v("wants to upload and manage multiple contacts at once")])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a/an …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("new user")]),_v(" "),_c('td',[_v("see usage instructions")]),_v(" "),_c('td',[_v("refer to instructions when I forget how to use the App")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("add a new person")]),_v(" "),_c('td',[_v("so that I can save basic contact details")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("view all contacts")]),_v(" "),_c('td',[_v("so that I can see all the contacts in my address book")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("delete a person")]),_v(" "),_c('td',[_v("remove entries that I no longer need")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("find a person by name")]),_v(" "),_c('td',[_v("locate details of persons without having to go through the entire list")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("find a person by number")]),_v(" "),_c('td',[_v("locate details of persons without having to go through the entire list")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("export contacts to a vCard (vcf) or Csv file")]),_v(" "),_c('td',[_v("easily share or import them into other applications")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("identify duplicate contacts")]),_v(" "),_c('td',[_v("maintain a clean address book")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("delete multiple contacts at once through tags")]),_v(" "),_c('td',[_v("maintain a clean address book easier")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("add notes to certain contacts")]),_v(" "),_c('td',[_v("get details of a contact")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("event organiser")]),_v(" "),_c('td',[_v("import contacts from a CSV file and VCF file")]),_v(" "),_c('td',[_v("add multiple contacts quickly")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("event organiser")]),_v(" "),_c('td',[_v("quickly type out contacts from handwritten contact details")]),_v(" "),_c('td',[_v("quickly add them to group chats")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user with many persons in the address book")]),_v(" "),_c('td',[_v("sort contacts alphabetically")]),_v(" "),_c('td',[_v("organise details of persons easily")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("restore accidentally deleted contacts")]),_v(" "),_c('td',[_v("don't lose important information")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("have the option to add contacts step-by-step for each contact detail")]),_v(" "),_c('td',[_v("don't need to use unfamiliar flags")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("user with wrong details of a person")]),_v(" "),_c('td',[_v("edit the persons information")]),_v(" "),_c('td',[_v("modify a persons information")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("user contacting the same person frequently")]),_v(" "),_c('td',[_v("mark a person as favourite")]),_v(" "),_c('td',[_v("quickly access the persons information")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("set certain contacts as VIPs")]),_v(" "),_c('td',[_v("find important contacts faster")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("be warned before deleting a contact")]),_v(" "),_c('td',[_v("don't accidentally remove important information")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("add multiple phone numbers or emails for a contact")]),_v(" "),_c('td',[_v("have alternate ways to contact that person")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("event organiser")]),_v(" "),_c('td',[_v("tag contacts into groups")]),_v(" "),_c('td',[_v("categorize them")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("event organiser")]),_v(" "),_c('td',[_v("add multiple contacts in one command")]),_v(" "),_c('td',[_v("save time when entering bulk data")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("event organiser")]),_v(" "),_c('td',[_v("bulk edit multiple contacts")]),_v(" "),_c('td',[_v("update common details efficiently")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("share selected contacts via email")]),_v(" "),_c('td',[_v("send them to my colleagues")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("enable dark mode")]),_v(" "),_c('td',[_v("use the application comfortably in low-light environments")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("event organiser")]),_v(" "),_c('td',[_v("set reminders for follow-ups")]),_v(" "),_c('td',[_v("stay on top of communication tasks")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("search for a contact using partial matches")]),_v(" "),_c('td',[_v("find people even if I don't remember their full details")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("interact with the application fully through keyboard")]),_v(" "),_c('td',[_v("do tasks quickly")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("undo my last action")]),_v(" "),_c('td',[_v("recover from mistakes/typos")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("view recently added contacts")]),_v(" "),_c('td',[_v("verify my latest entries")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("event organiser")]),_v(" "),_c('td',[_v("see autocomplete suggestions and use them")]),_v(" "),_c('td',[_v("do tasks quicker")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("view contact history (last modified, date added etc)")]),_v(" "),_c('td',[_v("track updates")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("use natural language commands")]),_v(" "),_c('td',[_v("don't have to memorize syntax")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("event organiser")]),_v(" "),_c('td',[_v("email a group of contacts directly from the app")]),_v(" "),_c('td',[_v("send bulk communications")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("event organiser")]),_v(" "),_c('td',[_v("filter contacts by details quickly and get an updated list of matching contacts on the fly")]),_v(" "),_c('td',[_v("find contacts easier")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("event organiser")]),_v(" "),_c('td',[_v("edit a contact's details")]),_v(" "),_c('td',[_v("update outdated information")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Listify")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("user")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list persons.")])]),_v(" "),_c('li',[_c('p',[_v("Listify shows a list of persons.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to delete a specific person in the list.")])]),_v(" "),_c('li',[_c('p',[_v("Listify deletes the person.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. Listify shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list persons.")])]),_v(" "),_c('li',[_c('p',[_v("Listify shows a list of persons.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case: Find person(s)")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to find all person(s) containing the same names/phone numbers/roles/tags as the provided names/phone numbers/roles/tags.")])]),_v(" "),_c('li',[_c('p',[_v("Listify shows a list of person(s) the user requested.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The names/phone numbers/roles/tags in Listify do not contain any of the user provided names/phone numbers/roles/tags.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. Listify displays an empty list.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list persons.")])]),_v(" "),_c('li',[_c('p',[_v("Listify shows a list of persons.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to sort contacts.")])]),_v(" "),_c('li',[_c('p',[_v("Listify shows sorted list of persons.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The list contains contacts with same name.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. Listify sorts the contacts by phone number.")]),_v(" "),_c('p',[_v("Use case resumes from step 4.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Export contacts to CSV")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to export contacts to a CSV file.")])]),_v(" "),_c('li',[_c('p',[_v("Listify exports all contacts to a CSV file.")])]),_v(" "),_c('li',[_c('p',[_v("Listify shows a success message with the saved file location."),_c('br')]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The provided filename is invalid")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. Listify shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. The export file creation failed")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. Listify shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1c. A file with the given filename given already exists")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1c1. Listify shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Export contacts to VCF")]),_c('br'),_v("\nSimilar to Export contacts to CSV use case, except for the file type.")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to export contacts to a VCF file.")])]),_v(" "),_c('li',[_c('p',[_v("Listify exports all contacts to a VCF file.")])]),_v(" "),_c('li',[_c('p',[_v("Listify shows a success message with the saved file location."),_c('br')]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case: Import contacts from CSV")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to import contacts from a CSV file.")])]),_v(" "),_c('li',[_c('p',[_v("System validates the file path and format.")])]),_v(" "),_c('li',[_c('p',[_v("System reads the CSV file and parses the contact data.")])]),_v(" "),_c('li',[_c('p',[_v("System adds valid contacts to the address book.")])]),_v(" "),_c('li',[_c('p',[_v("System displays a success message with the number of contacts imported.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. File path is invalid or file does not exist.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. System displays an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("2b. File format is not CSV.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2b1. System displays an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("3a. CSV file has an invalid header.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. System displays an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("3b. CSV file is empty.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3b1. System displays a message indicating no contacts were imported.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("4a. Some contacts have invalid data.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("4a1. System skips invalid contacts.")])]),_v(" "),_c('li',[_c('p',[_v("4a2. System continues importing valid contacts.")])]),_v(" "),_c('li',[_c('p',[_v("4a3. System reports the rows with errors in the result message.")]),_v(" "),_c('p',[_v("Use case resumes from step 5.")])])])]),_v(" "),_c('li',[_c('p',[_v("4b. Some contacts are duplicates of existing contacts.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("4b1. System skips duplicate contacts.")])]),_v(" "),_c('li',[_c('p',[_v("4b2. System continues importing non-duplicate contacts.")])]),_v(" "),_c('li',[_c('p',[_v("4b3. System reports the duplicate entries in the result message.")]),_v(" "),_c('p',[_v("Use case resumes from step 5.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Import contacts from VCF")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to import contacts from a VCF file.")])]),_v(" "),_c('li',[_c('p',[_v("System validates the file path and format.")])]),_v(" "),_c('li',[_c('p',[_v("System reads the VCF file and parses the contact data.")])]),_v(" "),_c('li',[_c('p',[_v("System adds valid contacts to the address book.")])]),_v(" "),_c('li',[_c('p',[_v("System displays a success message with the number of contacts imported.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. File path is invalid or file does not exist.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. System displays an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("2b. File format is not VCF.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2b1. System displays an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("4a. Some contacts have invalid data.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("4a1. System skips invalid contacts.")])]),_v(" "),_c('li',[_c('p',[_v("4a2. System continues importing valid contacts.")])]),_v(" "),_c('li',[_c('p',[_v("4a3. System reports the contacts with errors in the result message.")]),_v(" "),_c('p',[_v("Use case resumes from step 5.")])])])]),_v(" "),_c('li',[_c('p',[_v("4b. Some contacts are duplicates of existing contacts.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("4b1. System skips duplicate contacts.")])]),_v(" "),_c('li',[_c('p',[_v("4b2. System continues importing non-duplicate contacts.")])]),_v(" "),_c('li',[_c('p',[_v("4b3. System reports the duplicate entries in the result message.")]),_v(" "),_c('p',[_v("Use case resumes from step 5.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Edit persons information")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list persons.")])]),_v(" "),_c('li',[_c('p',[_v("Listify shows a list of persons.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to edit a specific person in the list.")])]),_v(" "),_c('li',[_c('p',[_v("Listify updates the person information.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The updated information is not valid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. Listify shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Mark a contact as contacted")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list persons.")])]),_v(" "),_c('li',[_c('p',[_v("Listify shows a list of persons.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to mark a specific person in the list as contacted.")])]),_v(" "),_c('li',[_c('p',[_v("Listify updates the person's last contacted time.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case: Delete multiple person(s) with the same tag")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list persons.")])]),_v(" "),_c('li',[_c('p',[_v("Listify shows a list of persons.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to delete any person(s) with the same provided tag.")])]),_v(" "),_c('li',[_c('p',[_v("Listify deletes all person(s) with the provided tag.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The provided tag doesn't match any existing tags.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. Listify shows 0 person(s) deleted.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS.")]),_v(" "),_c('li',[_c('strong',[_v("Contact")]),_v(" - An individual an organisation/party has interest in communicating with.")]),_v(" "),_c('li',[_c('strong',[_v("Contact Details")]),_v(" - Adjectives that can describe a contact including but not limited to Contact Name, Phone Number, and Email.")]),_v(" "),_c('li',[_c('strong',[_v("CSV File")]),_v(" - (Comma-Separated Values) a simple text file that stores data in a tabular format, where each line represents a row and values within a row are separated by commas.")]),_v(" "),_c('li',[_c('strong',[_v("VCF File")]),_v(" - (vCard or Virtual Contact File) a common file format used to store and exchange digital contact information across devices and platforms (iCloud, Google Contacts, etc.).")]),_v(" "),_c('li',[_c('strong',[_v("Event Organisers")]),_v(" – Tech-savvy event organisers who are fast typists and deal with large amounts of contacts.")]),_v(" "),_c('li',[_c('strong',[_v("Tag")]),_v(" - To associate a contact with a particular group.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Initial launch")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Download the jar file and copy into an empty folder")])]),_v(" "),_c('li',[_c('p',[_v("Double-click the jar file"),_c('br'),_v(" Expected: Shows the GUI with a set of sample contacts. The window size may not be optimum.")])])])]),_v(" "),_c('li',[_c('p',[_v("Saving window preferences")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Resize the window to an optimum size. Move the window to a different location. Close the window.")])]),_v(" "),_c('li',[_c('p',[_v("Re-launch the app by double-clicking the jar file."),_c('br'),_v("\nExpected: The most recent window size and location is retained.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Export/Import Data")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Test case: Export data to a different format (CSV/VCF), delete all contacts, then import.")]),_v(" "),_c('p',[_v("Expected: All contacts should be restored after import.")])])])]),_v(" "),_c('li',[_c('p',[_v("Auto save on exit")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Test case: Modify data, then exit application.")]),_v(" "),_c('p',[_v("Expected: Changes are automatically saved without explicit save command.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Ensure the application is running and the imports directory is accessible.")]),_v(" "),_c('li',[_v("Prepare test CSV and VCF files with various scenarios (valid entries, invalid entries, duplicates).")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Test Cases")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Basic Import Functionality")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Execute: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("import validfile.csv")])]),_v(" "),_c('p',[_v("Expected: Success message with the number of contacts imported.")])])])]),_v(" "),_c('li',[_c('p',[_v("File Format Handling")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Execute: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("import validfile.vcf")])]),_v(" "),_c('p',[_v("Expected: Success message with the number of contacts imported.")])]),_v(" "),_c('li',[_c('p',[_v("Execute: import "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("invalidfile.txt")])]),_v(" "),_c('p',[_v("Expected: Error message about unsupported file type.")])])])]),_v(" "),_c('li',[_c('p',[_v("Empty File Handling")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Import an empty CSV/VCF file.")]),_v(" "),_c('p',[_v("Expected: Error message stating no contacts in file.")])])])]),_v(" "),_c('li',[_c('p',[_v("Duplicate Handling")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Import a file with duplicate entries only.")]),_v(" "),_c('p',[_v("Expected: Error message with duplicates reported.")])])])]),_v(" "),_c('li',[_c('p',[_v("Invalid Data Handling")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Import a CSV/VCF file with invalid data (e.g., malformed email, invalid phone number).")]),_v(" "),_c('p',[_v("Expected: Error message listing invalid entries, valid entries still imported.")])])])]),_v(" "),_c('li',[_c('p',[_v("Large File Handling")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Import a CSV/VCF file with a large number of valid entries (e.g., 1000+).")]),_v(" "),_c('p',[_v("Expected: Success message, all valid entries imported.")])])])]),_v(" "),_c('li',[_c('p',[_v("Partial Import")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Import a file with some valid and some invalid entries.")]),_v(" "),_c('p',[_v("Expected: Success message for valid entries, error messages for invalid ones.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Exporting contacts with valid filename and contacts added")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: Have contacts added in the app.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: export to valid CSV filename "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("export a.csv")]),_v("."),_c('br'),_v("\nExpected: File exports successfully.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: export to valid VCF filename "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("export b.vcf")]),_v("."),_c('br'),_v("\nExpected: File exports successfully.")])])])]),_v(" "),_c('li',[_c('p',[_v("Exporting contacts with invalid filename and contacts added.")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: Have contacts added in the app.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: export to invalid CSV filename "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("export .csv")]),_v("."),_c('br'),_v("\nExpected: Error message about invalid filename.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: export to invalid VCF filename "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("export !@#$%^'::'.vcf")]),_v("."),_c('br'),_v("\nExpected: Error message about invalid filename.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: export to invalid filename "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("export aaa")]),_v("."),_c('br'),_v("\nExpected: Error message about invalid filename.")])])])]),_v(" "),_c('li',[_c('p',[_v("Exporting contacts with no contacts added")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: run the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("clear")]),_v(" command to remove all contacts."),_c('br'),_v("\nExpected: All contacts removed from app.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: export to valid CSV filename "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("export a.csv")]),_v("."),_c('br'),_v("\nExpected: Error message about no contacts.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: export to valid VCF filename "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("export b.vcf")]),_v("."),_c('br'),_v("\nExpected: Error message about no contacts.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"sort-contacts"}},[_v("Sort contacts"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#sort-contacts","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Prerequisites")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("List all persons using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple persons in the list.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Test Cases")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Sort contacts in ascending order")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Execute: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort asc")])]),_v(" "),_c('p',[_v("Expected: Contacts sorted by name (then phone) in ascending order.")])])])]),_v(" "),_c('li',[_c('p',[_v("Sort contacts in descending order")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Execute: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort desc")])]),_v(" "),_c('p',[_v("Expected: Contacts sorted by name (then phone) in descending order.")])])])]),_v(" "),_c('li',[_c('p',[_v("Sort an empty contact list")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: run the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("clear")]),_v(" command to remove all contacts.")])]),_v(" "),_c('li',[_c('p',[_v("Execute: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort asc")])]),_v(" "),_c('p',[_v("Expected: No contacts to sort.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"mark-person-as-contacted"}},[_v("Mark person as contacted"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#mark-person-as-contacted","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Prerequisites")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Ensure the application is populated with contacts.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Test Cases")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Contact the 1st person in the list")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Execute: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("contact 1")])]),_v(" "),_c('p',[_v("Expected: Contact 1 marked as contacted.")])])])]),_v(" "),_c('li',[_c('p',[_v("Invalid index number handling")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Execute: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("contact 2147483648")])]),_v(" "),_c('p',[_v("Expected: Invalid index number.")])])])]),_v(" "),_c('li',[_c('p',[_v("Invalid string input handling")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Execute: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("contact bob")])]),_v(" "),_c('p',[_v("Expected: Invalid command format or usage.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Listify must be running.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Test Cases:")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Valid Inputs")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Execute: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01 r/Vendor")])]),_v(" "),_c('p',[_v("Expected: Contact is added, success message shown.")])]),_v(" "),_c('li',[_c('p',[_v("Execute: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/Betsy Crowe t/friend e/betsycrowe@example.com a/Newgate Prison p/1234567 r/Software Engineer t/criminal")])]),_v(" "),_c('p',[_v("Expected: Contact with multiple tags is added, success message shown.")])])])]),_v(" "),_c('li',[_c('p',[_v("Invalid Inputs")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Execute: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/John Doe p/abcd e/email@com a/Somewhere r/Developer")])]),_v(" "),_c('p',[_v("Expected: Error message for invalid phone number.")])]),_v(" "),_c('li',[_c('p',[_v("Execute: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add")]),_v(" (with missing fields)")]),_v(" "),_c('p',[_v("Expected: Error message shown.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("At least one person must be in the list.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Test Cases:")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Basic Field Edits")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Execute: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 p/91234567 e/johndoe@example.com")])]),_v(" "),_c('p',[_v("Expected: First person’s phone and email are updated, success message shown.")])]),_v(" "),_c('li',[_c('p',[_v("Execute: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 2 n/Betsy Crower t/")])]),_v(" "),_c('p',[_v("Expected: Second person's name is changed, tags are cleared.")])])])]),_v(" "),_c('li',[_c('p',[_v("Invalid Edits")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Execute: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 0 p/1234567")])]),_v(" "),_c('p',[_v("Expected: Error message shown.")])]),_v(" "),_c('li',[_c('p',[_v("Execute: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1")])]),_v(" "),_c('p',[_v("Expected: Error message stating at least one field to edit must be provided.")])]),_v(" "),_c('li',[_c('p',[_v("Execute: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit x n/Test")])]),_v(" "),_c('p',[_v("Expected: Error message shown.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"locating-persons"}},[_v("Locating persons"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#locating-persons","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Prerequisites:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Add multiple people with varying names, phone numbers, roles, and tags.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Test Cases:")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Name Search")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Execute: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find n/John")])]),_v(" "),_c('p',[_v("Expected: All contacts with names containing \"John\" are listed.")])]),_v(" "),_c('li',[_c('p',[_v("Execute: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find n/alex n/david")])]),_v(" "),_c('p',[_v("Expected: All contacts matching either keyword are shown.")])])])]),_v(" "),_c('li',[_c('p',[_v("Phone Search")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Execute: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find p/98765432")])]),_v(" "),_c('p',[_v("Expected: Contact with matching phone number is listed.")])]),_v(" "),_c('li',[_c('p',[_v("Execute: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find p/98765432 98761234")])]),_v(" "),_c('p',[_v("Expected: Error message shown stating phone number provided is invalid.")])]),_v(" "),_c('li',[_c('p',[_v("Execute: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find p/98765432 p/98761234")])]),_v(" "),_c('p',[_v("Expected: Contacts with matching numbers shown.")])])])]),_v(" "),_c('li',[_c('p',[_v("Role/Tag Search")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Execute: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find r/Software")])]),_v(" "),_c('p',[_v("Expected: Contacts with matching roles (e.g., Software Engineer) listed.")])]),_v(" "),_c('li',[_c('p',[_v("Execute: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find t/friend")])]),_v(" "),_c('p',[_v("Expected: Contacts with the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("friend")]),_v(" tag listed.")])])])]),_v(" "),_c('li',[_c('p',[_v("Invalid Search")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Execute: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find n/john p/98765432")])]),_v(" "),_c('p',[_v("Expected: Error message shown.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"deleting-multiple-people-with-the-same-tag"}},[_v("Deleting multiple people with the same tag"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#deleting-multiple-people-with-the-same-tag","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Prerequisites:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Ensure multiple contacts have a common tag.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Test Cases:")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Valid Deletion by Tag")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Execute: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(", then "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deletewithtag colleagues")])]),_v(" "),_c('p',[_v("Expected: All contacts with tag "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("colleagues")]),_v(" are deleted.")])])])]),_v(" "),_c('li',[_c('p',[_v("Tag Not Found")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Execute: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deletewithtag nonexistenttag")])]),_v(" "),_c('p',[_v("Expected: No contacts deleted and \"0 persons deleted!\" message shown.")])])])]),_v(" "),_c('li',[_c('p',[_v("Case Insensitivity")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Execute: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deletewithtag FRIEND")])]),_v(" "),_c('p',[_v("Expected: Contacts with tag "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("friend")]),_v(" are deleted regardless of case.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Team size: 5")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Allow more flexibility for "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Name")]),_v(" field: Allow symbols such as s/o, hyphens, @, Arabic and Tamil names so that users can input names such as “Nagaratnam s/o Suppiah”, “Chloe-Jasmine”, “Tan Cheng Bok @ Adrian Tan”, \"X Æ A-Xii\" and “அபிஷேக்”).")])]),_v(" "),_c('li',[_c('p',[_v("More input choices for "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("contact")]),_v(" command: To allow flexibility to users by allowing other timing and not just current time.")])]),_v(" "),_c('li',[_c('p',[_v("Import and export command to include last contacted timing field: Currently, the import and export command only include the following fields: Name, Phone, Email, Address, Role, Tags. We plan to also import/export the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Last contacted")]),_v(" field.")])]),_v(" "),_c('li',[_c('p',[_v("Word wrap based on how wide the GUI window is (when input provided by user is too long, line break and specify clearly which field each line belongs to)")])]),_v(" "),_c('li',[_c('p',[_v("Input validation for phone numbers to allow alphanumeric chars such as (, ), + and spaces for a clearer view of users input numbers.")])]),_v(" "),_c('li',[_c('p',[_v("More sorting choices for "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort")]),_v(" command: Currently, the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort")]),_v(" command only allows sorting by "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("name")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("phone")]),_v(". We plan to allow users to also sort by "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("tag")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("role")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("last contacted")]),_v(".")])]),_v(" "),_c('li',[_c('p',[_v("Allow multiple prefixes for "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find")]),_v(" command: Currently, the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find")]),_v(" command only allows searching for contacts by one prefix. We plan to allow users to also search for contacts by multiple prefixes. Example: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find n/John e/john@gmail.com p/78989456")]),_v(".")])]),_v(" "),_c('li',[_c('p',[_v("Flexibility with exports: Allow users to export only selected contacts that are listed in the app. Example: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find t/friends")]),_v(" followed by "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("export")]),_v(" will only export contacts with the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("friends")]),_v(" tag.")])])])}
},function anonymous(
) {
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Tue, 8 Apr 2025, 3:36:54 GMT+8]")])])])}
}];
