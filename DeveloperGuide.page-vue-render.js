...
with(this){return _c('p',[_c('strong',[_v("Use case: Find a person by name")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to find a person by name.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook shows the specific person user requested.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The persons name is not added to AddressBook.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. AddressBook shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Find a person by number")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to find a person by number.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook shows the specific person user requested.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The persons number is not added to AddressBook.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. AddressBook shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Exporting contacts with valid filename and contacts added")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: Have contacts added in the app")])]),_v(" "),_c('li',[_c('p',[_v("Test case: export to valid csv filename "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("export a.csv")]),_c('br'),_v("\nExpected: File exports successfully")])]),_v(" "),_c('li',[_c('p',[_v("Test case: export to valid vcf filename "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("export b.vcf")]),_c('br'),_v("\nExpected: File exports successfully")])])])]),_v(" "),_c('li',[_c('p',[_v("Exporting contacts with invalid filename and contacts added")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: Have contacts added in the app.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: export to invalid csv filename "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("export .csv")]),_c('br'),_v("\nExpected: Error message about invalid filename.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: export to invalid vcf filename "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("export !@#$%^'::'.vcf")]),_c('br'),_v("\nExpected: Error message about invalid filename.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: export to invalid filename "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("export aaa")]),_c('br'),_v("\nExpected: Error message about invalid filename.")])])])]),_v(" "),_c('li',[_c('p',[_v("Exporting contacts with no contacts added")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: run the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("clear")]),_v(" command to remove all contacts\nExpected: All contacts removed from app")])]),_v(" "),_c('li',[_c('p',[_v("Test case: export to valid csv filename "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("export a.csv")]),_c('br'),_v("\nExpected: Error message about no contacts")])]),_v(" "),_c('li',[_c('p',[_v("Test case: export to valid vcf filename "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("export b.vcf")]),_c('br'),_v("\nExpected: Error message about no contacts")])])])])])}
},function anonymous(
) {
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Thu, 3 Apr 2025, 22:58:43 GMT+8]")])])])}
}];
