...
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The persons name is not added to AddressBook")]),_v(" "),_c('ul',[_c('li',[_v("2a1. AddressBook shows an error message.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The persons number is not added to AddressBook")]),_v(" "),_c('ul',[_c('li',[_v("2a1. AddressBook shows an error message.")])]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to import contacts from a VCF file")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook takes in a VCF file")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook adds contacts from VCF file to current contact list")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook shows list of persons with added contacts from VCF file")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("3a. The VCF file is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Use case: Mark person as favourite")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list persons")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook shows a list of persons")])]),_v(" "),_c('li',[_c('p',[_v("User requests to favourite a specific person in the list")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook favourites the person")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Private contact detail")]),_v(": A contact detail that is not meant to be shared with others")]),_v(" "),_c('li',[_c('strong',[_v("Admin Staff")]),_v(" - An individual performing secretarial and administrative duties such as managing, liaising, and scheduling contacts")]),_v(" "),_c('li',[_c('strong',[_v("Contact")]),_v(" - An individual an organisation/party has interest in communicating with.")]),_v(" "),_c('li',[_c('strong',[_v("Contact Details")]),_v(" - Adjectives that can describe a contact including but not limited to Contact Name, Phone Number, and Email")]),_v(" "),_c('li',[_c('strong',[_v("CSV File")]),_v(" - a simple text file that stores data in a tabular format, where each line represents a row and values within a row are separated by commas")]),_v(" "),_c('li',[_c('strong',[_v("Tag")]),_v(" - To associate a Contact with a particular group")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Wed, 26 Mar 2025, 17:58:52 GMT+8]")])])])}
}];
